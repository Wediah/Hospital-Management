...
<body>
    ...
    <div class="appt-head">
        ...
        <div>
            <button class="appt-bttn" data-bs-toggle="modal" data-bs-target="#staticBackdropC">+ Add Patient</button>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="forms1" name="signup" action="paProcessSignup1.php" method="post">
    ...
    if ($result->num_rows > 0) {
        echo "<table>";
        echo "<tr><th>Serial Number</th><th>First Name</th><th>Last Name</th><th>Email</th><th>Phone</th><th>Date of Birth</th><th>Gender</th><th>Password</th></tr>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td class='action-buttons'>
                    <a href='editPa1.php?id=" . $row["id"] . "'>Edit</a>
                    <a href='deletePa1.php?id=" . $row["id"] . "'>Delete</a>
                  </td>";
            echo "</tr>";
        }
