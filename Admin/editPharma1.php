...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE pharma SET fullname='$fname', email='$email', phone='$phone',password='$password'  WHERE id=$id";

    if ($conn->query($sql) === TRUE) {
        echo "Record updated successfully!";
        header("Location: pharma1.php");
    } else {
...
$id = $_GET['id'];
$sql = "SELECT * FROM pharma WHERE id=$id";
