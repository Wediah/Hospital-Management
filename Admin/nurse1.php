...
<body>
    ...
    <div class="appt-head">
        ...
        <div>
            <button class="appt-bttn" data-bs-toggle="modal" data-bs-target="#staticBackdropB">+ Add Doctor</button>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="forms1" name="signup" action="nurseProcessSignup1.php" method="post">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td class='action-buttons'>
                    <a href='editNurse1.php?id=" . $row["id"] . "'>Edit</a>
                    <a href='deleteNurse1.php?id=" . $row["id"] . "'>Delete</a>
                  </td>";
            echo "</tr>";
        }
