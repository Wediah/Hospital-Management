...
<body>
    ...
    <div class="appt-head">
        ...
        <div>
            <button class="appt-bttn" data-bs-toggle="modal" data-bs-target="#staticBackdropD">+ Add Laboratorist</button>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="forms1" name="signup" action="labProcessSignup1.php" method="post">
