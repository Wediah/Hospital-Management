...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE admin SET fullname='$fname', department='$department', email='$email', phone='$phone', password='$password' WHERE id=$id";
...
<body>
    ...
    <form class="forms" method="post" action="">
        ...
        <input type="text" id="fname" name="fname" value="<?php echo $user_data['fullname']; ?>">
